                ...
                <div className="flex flex-col w-[100%] border-1 rounded-3xl bg-white p-2 text-neutral-600 ">
                    <form className="flex flex-col pt-8 pl-10 w-[100%]">
                        ...
                        <section className="flex flex-col">
                            ...
                            <button className="bg-purple-600 h-12 w-48 rounded-xl text-white font-semibold hover:bg-purple-200 hover:text-purple-500 transition hover:delay-100 hover:border-2 hover:border-purple-600 z-index-10">   
                                Browse Files
                            </button>
