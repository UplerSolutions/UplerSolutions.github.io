...
export const CustomForm = () => {
    return (
        <div className="bg-gradient-to-r from-[#fde9fc] to-[#fffbe0] flex justify-center items-center">
            <div className="flex flex-col w-[90%] rounded-lg md:w-[75%] pb-20">
                ...
                <div className="flex w-[100%] border-1 rounded-3xl bg-white p-2 text-neutral-600 ">
                    <form className="flex flex-col py-8 pl-10 w-[100%]">
                        <h2 className="text-3xl pb-8 font-semibold" >Company details</h2>
                        <section className="">
                            <fieldset className="flex flex-col ">
                                <h3 className="text-xl py-4">Company Type*</h3>
                                <label htmlFor="type">
                            ...
                            <fieldset className="flex flex-col">
                                <h3 className="text-xl pt-8 pb-4">Company Sector*</h3>
                                <div className="flex flex-wrap justify-between gap-5 ">
                                <label htmlFor="sector" className="w-[40%] md:w-[150px] lg:w-[200px] xl:w-[30%]">
                            ...
                            <fieldset className="flex flex-col gap-5">
                                <label htmlFor="company-name" className="text-xl pt-10 pb-4">Company Name*</label>
                                <input type="text" placeholder="Uplix" name="company-name" className="py-3 px-3 border-2 rounded-2xl mr-10"/>

                                <label htmlFor="company-address" className="text-xl py-4">Company Registered Address*</label>
                                <input type="text" placeholder="Avenue 123, Argentina" name="company-address" className="py-3 px-3  border-2 rounded-2xl mr-10"/>

                                <label htmlFor="company-name" className="text-xl py-4">Company Website*</label>
                                ...
                                <label htmlFor="company-email" className="text-xl py-4">Company Email*</label>
                        ...
                        <section className="flex flex-col">
                            <h2 className="text-xl py-4">Attach File</h2>
                        ...
                        <section>
                            <fieldset className="flex flex-col gap-5">
                                <h2 className="text-3xl pt-14 pb-4">Personal Information</h2>
