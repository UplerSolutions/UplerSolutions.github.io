...
const Checkbox: FC<CheckboxProps> = ({
  ...
  return isChecked ? (
    <div className='h-[40vh] 2xl:h-[35vh] border-2 border-primary-color flex flex-col w-full bg-white rounded-xl p-6 gap-10 mb-10 items-center text-center'>
      <div>
    ...
    <div className='h-[40vh] 2xl:h-[35vh] border-2 flex flex-col w-full bg-white rounded-xl p-6 gap-10 mb-10 items-center text-center '>
      <div>
        <label htmlFor={`checkbox-${value}`}>
          <input
            {...register('products')}
