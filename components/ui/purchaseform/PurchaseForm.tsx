    ...
    <FormProvider {...methods}>
      <form onSubmit={methods.handleSubmit(onSubmit)}>
        <section className='pt-32 flex flex-col justify-center items-center w-full bg-gradient-to-r from-[#fde9fc] to-[#fffbe0] '>
          <div className='first-letter:rounded-xl flex flex-row p-6 sm:py-10 sm:pl-10 bg-gradient-to-r from-[#fff5ff] to-[#fffdf0] text-neutral-700 lg:w-[75%] '>
          ...
          <div className='bg-gradient-to-r from-[#fff5ff] to-[#fffdf0] mt-8 px-6 md:px-8 2xl:px-0  py-8  mb-8 rounded-xl lg:w-[75%] w-[90%]'>
            <div className='text-2xl md:text-[28px] lg:text-[32px] xl:text-[36px] font-bold w-full'>
              <h2 className='md:pb-10 pl-10 pt-6 text-neutral-600'>
                1. Choose a Period
              </h2>
            </div>
        ...
        <section className='flex flex-col justify-center  items-center w-full bg-gradient-to-r from-[#fde9fc] to-[#fffbe0]'>
          <div className='rounded-xl flex flex-col p-6 sm:py-16 sm:pl-8 pr-8 bg-gradient-to-r from-[#fff5ff] to-[#fffdf0] text-neutral-700 w-[90%] lg:w-[75%]'>
            <div className='text-2xl md:text-[28px] lg:text-[32px] xl:text-[36px] font-bold w-full'>
              <h2 className='md:pb-10 md:pl-4 text-neutral-600'>
        ...
        <section className='flex flex-col justify-center  items-center w-full bg-gradient-to-r from-[#fde9fc] to-[#fffbe0] '>
          <div className='flex flex-col justify-center items-center xl:items-start text-center xl:text-start bg-gradient-to-r from-[#fff5ff] to-[#fffdf0] mt-10 py-8 px-6 mb-8 rounded-xl lg:w-[75%] w-[90%] '>
          ...
          <div className='xl:pl-[3.2rem] pb-14'>
            <button
              type='submit'
