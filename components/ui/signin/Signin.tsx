...
const SigninButton = () => {
  ...
  if (session && session.user) {
    return (
      <div className='flex gap-4 md:ml-auto items-center justify-center'>
  ...
  return (
    <div className='flex gap-3'>
      <Link href='/login'>
        <button className=' w-20 group relative inline-block overflow-hidden rounded-xl    border-fuchsia-100 bg-fuchsia-200 px-2  py-3 text-sm font-semibold text-primary-color hover:text-primary-color focus:outline-none focus:ring active:bg-primary-color active:text-white'>
      ...
      <Link href='/signup'>
        <button className='w-20 border-2 border-primary-color group relative px-2  bg-primary-color h-11 rounded-xl text-white font-semibold hover:bg-fuchsia-200 hover:text-primary-color transition hover:delay-100 hover:border-2 hover:border-primary-color'>
          Signup
        </button>
      </Link>
    </div>
