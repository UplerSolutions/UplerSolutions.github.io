...
const SigninButton = () => {
  ...
  return (
    <div className='flex gap-3'>
      <Link href='/login'>
        <button className='w-20 group relative inline-block overflow-hidden rounded-xl    border-fuchsia-100 bg-fuchsia-200 px-2 lg:px-6 py-3 text-sm font-semibold text-primary-color hover:text-primary-color focus:outline-none focus:ring active:bg-primary-color active:text-white'>
