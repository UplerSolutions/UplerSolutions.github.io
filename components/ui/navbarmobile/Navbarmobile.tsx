...
export const Navbarmobile = () => {
  return (
    <nav className='flex lg:hidden items-center justify-center w-full'>
      <div className='flex z-10 w-full text-lg items-center justify-center font-mono lg:hidden bg-neutral-100 text-neutral-700 pt-3 pb-3 gap-3 fixed bottom-0 h-[45px]'>
